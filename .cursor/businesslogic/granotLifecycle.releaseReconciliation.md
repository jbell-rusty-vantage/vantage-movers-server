...
**Role:** Persist read-only owner work for an actual Granot Release without automatically changing a Booking, Cancellation, Lead, Record Link, Sheet, or discrepancy. A Release case is not a Cancellation and is separate from a Booking case.
