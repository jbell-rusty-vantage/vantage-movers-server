...
Stay in **`leads`**. Next module: **`leadCplResolution.ts`**.

1. Take stock first. Disk now has `form-lead.md` + `leads-call-lead.md` + `leads-duplicate-lead.md` + `leads-ingestion-provenance.md` + `leads-source-company.md`.
2. Do not rewrite `form-lead.md`, `leads-call-lead.md`, `leads-duplicate-lead.md`, `leads-ingestion-provenance.md`, or `leads-source-company.md`.
