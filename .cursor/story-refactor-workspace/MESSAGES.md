...
4. No `src/` edits. Branch `docs/story-refactor`. Open a new PR if the latest story-refactor PR is already merged (PR #122 merged; this pass opens the next story-refactor PR).
