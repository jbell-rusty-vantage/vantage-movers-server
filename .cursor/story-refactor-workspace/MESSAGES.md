...
4. No `src/` edits. Branch `docs/story-refactor`. Open a new PR if the latest story-refactor PR is already merged (this pass continues https://github.com/jbell-rusty-vantage/vantage-movers-server/pull/106).
