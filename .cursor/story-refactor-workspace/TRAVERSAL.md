...
### 39. `conversations` — medium — **in-progress**
...
### 40. `extensionUsers` — small — unvisited

`src/services/extensionUsers/` — parked after listed Wave A (rows 1–38). Enumerate before Wave B.

### 41. `jobNumberTimeline` — large — unvisited

`src/services/jobNumberTimeline/` — parked after listed Wave A (rows 1–38). Enumerate before Wave B. Do not write a whole-folder recommendation.
