...
### 39. `conversations` — medium — unvisited

`src/services/conversations/` — parked after listed Wave A (rows 1–38). Enumerate before Wave B.
