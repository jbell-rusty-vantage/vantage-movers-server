...
description: Current local Vantage Admin URL for operational-surfaces work. Not a product authority.
status: ready
...
- Duplicate Form Leads: `http://localhost:3000/duplicate-form-leads`
- Duplicate Call Leads: `http://localhost:3000/duplicate-call-leads`
