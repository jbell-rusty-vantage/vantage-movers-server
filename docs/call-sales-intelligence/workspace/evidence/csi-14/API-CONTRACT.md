...
{
  "expected_revision": 7,
  "expected_rep_revision": 3,
  "nudge": {
    "outreach_record_id": "aaaaaaaaaaaaaaaaaaaaaaaa",
    "rep_identity_link_id": "bbbbbbbbbbbbbbbbbbbbbbbb",
...
```json
{
  ...
  "data": {
    ...
    "expected_revision": 7, "expected_rep_revision": 3,
    "recipient": {"agent_id": "cccccccccccccccccccccccc", "agent_name": "Alex Reed", "rep_identity_link_id": "bbbbbbbbbbbbbbbbbbbbbbbb", "channel": "team_messaging"},
...
| `SALES_INTELLIGENCE_NUDGE_PER_REP_PER_HOUR` | documented rate key: 6; integer 1–100, rolling hour per link; all persisted states reserve/count. Takes precedence over the supported `SALES_INTELLIGENCE_NUDGE_HOURLY_LIMIT` alias. |
