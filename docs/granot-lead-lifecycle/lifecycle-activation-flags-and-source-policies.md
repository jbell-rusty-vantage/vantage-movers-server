...
description: Owner-ready .env postures, Best Relocation create-if-missing seed facts, inbound Call event-class + adoption companion, and the model fields that actually gate lead_created behavior.
tags:
  - granot
  - lead-lifecycle
  - source-policy
