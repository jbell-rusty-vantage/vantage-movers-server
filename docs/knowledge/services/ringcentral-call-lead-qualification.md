...
Duplicate Call Leads still persist and **Sheet Sync** to `Duplicate Calls` tab (see [`call-lead.service.md`](../../../.cursor/businesslogic/call-lead.service.md)).
...
| [`call-lead.service.md`](../../../.cursor/businesslogic/call-lead.service.md) | Call Lead create semantics, CPL, sheet tabs |
