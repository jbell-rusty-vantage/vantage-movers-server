...
description: Fenced Best Relocation sheet inspect/preview/apply through canonical domain commands.
...
**Primary code:** `src/services/ingestion/`, `src/services/bestRelocationSheetIngest/`  
**Domain terms used:** [Form Lead](../../../../CONTEXT.md), [Call Lead](../../../../CONTEXT.md), [Booking](../../../../CONTEXT.md), [System of Record](../../../../CONTEXT.md), [Source Company](../../../../CONTEXT.md)
...
3. Planner reads sheets (readonly scope). Rows at or after `BEST_RELOCATION_CUTOFF` (`2026-04-30T04:00:00.000Z`, New York midnight) may enter the plan. Pre-cutoff observations never become actions. `LID_BestRelo` is matching evidence only — never an action.
...
- [`form-lead.md`](./form-lead.md) — trusted `ingestion_origin=best_relocation_sheet`
