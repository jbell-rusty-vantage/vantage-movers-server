...
applies_to:
  ...
  - vantage-admin/components/manual/connect-booking-section.tsx
...
- [Call Lead contact provenance](../../call-lead-contact-provenance/README.md) — Call operational phone stays the ingested caller; automatic intake match is Job, else granularity + phone. Call snapshot `q` is deferred (CLCP-05).
