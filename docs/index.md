...
| Path | Description |
| --- | --- |
| [daily-operations/daily-operations-specification.md](daily-operations/daily-operations-specification.md) | **Working contract.** Owner Daily Operations: category panels on `/daily`, Mongo day projection, Redis doorbell, SSE, hooks. Not Analytics, Live Events, or Observational. |
...
| [daily-operations/README.md](daily-operations/README.md) | Eight-issue pack (DOP-01–08). Daily Operations category-panel board. Mongo day projection + Redis doorbell + Admin `/daily`. Not the 2026-08-19 tabbed Daily View. |
