...
| [ORS-3](issues/ORS-3.md) | Aggregate Lead Source projection, single-feed setup, RingCentral DTOs | ORS-1, ORS-2 | `blocked` | — | — | — | — |
...
| §6.3 | `POST /admin/operations-registry/lead-source-setups` | ORS-3 | ☐ | |
...
| §7.4 | New Lead Source guided setup | ORS-4 | ☐ | |
