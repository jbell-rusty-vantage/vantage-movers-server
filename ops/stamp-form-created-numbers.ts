 ...
 *   node --env-file=.env --import tsx ops/stamp-form-created-numbers.ts --allow-production
 * Apply (from the deployed commit; drift guard):
 *   node --env-file=.env --import tsx ops/stamp-form-created-numbers.ts --apply --allow-production [--resume]
 ...
 *
 * Resumable: apply writes `ops/output/stamp-form-created-numbers.checkpoint.json` after
