...
const entry = path.join(root, 'ops/quality/hook-entry.mjs').replaceAll('\\', '/');
const marker = 'ops/quality/hook-entry.mjs';
...
for (const provider of ['codex', 'cursor']) {
  ...
  writeJson(projectFile, configuration(provider, 'node ops/quality/hook-entry.mjs', readJson(projectFile, {})));
