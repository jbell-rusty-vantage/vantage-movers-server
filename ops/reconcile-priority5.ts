 ...
 * Core and bucket definitions: `ops/lib/priority5-reconcile.ts`.
 *
 *   node --env-file=.env --import tsx ops/reconcile-priority5.ts [--limit=N]                        # dry run (read-only)
 *   node --env-file=.env --import tsx ops/reconcile-priority5.ts --allow-production                   # production dry run
