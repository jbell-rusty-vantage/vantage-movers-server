...
const database = `testvantagemovers_csi17${randomBytes(6).toString("hex")}`;
...
const child = spawn(process.execPath,["--import","tsx","--import","./scripts/test-setup.ts","--test","scripts/test-csi-intelligence.replica.test.ts"],{
...
console.log(`CSI-17 disposable proof: ${database}; loopback replica csi01:27189; synthetic evidence only`);
