...
HistoricalCallLeadSchema.index({ source_workbook: 1, source_tab: 1, source_row: 1 });
...
export type HistoricalCallLeadDocument = InferSchemaType<typeof HistoricalCallLeadSchema> & {
...
export function registerHistoricalCallLead(
  ...
  return (
    ...
    connection.model<HistoricalCallLeadDocument>("CallLead", HistoricalCallLeadSchema)
  );
}
