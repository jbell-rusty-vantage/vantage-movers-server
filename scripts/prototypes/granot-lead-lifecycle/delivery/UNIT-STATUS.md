...
| 25 | Existing Booking update and Booking No Action workflows | 24 | ready | complete | — |
...
- Unit 25 is now contract-permitted. It must independently reverify Unit 24, owns existing-Booking update and standard Booking No Action, and completes S16 before any separately authorized narrow Booking-command rollout.
