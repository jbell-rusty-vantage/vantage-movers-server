...
- **Specification and AC references:** Sections 11 and 15–16, deep interface Section 25, activation Section 27; AC-05–13, AC-30–32 in shadow.
...
origin-specific field authority, Priority behavior, temporal winner/tie-breaker, desired-state/no-op comparison, matched/no-match outcomes, pending scheduling decision, gate snapshot, and channel-neutral processor orchestration in historical/live shadow.
...
- **Approved unit-specific proof:** production-module tests for stale races, compare-and-swap loss/re-evaluation, already-current temporal advancement without revision/Change/outbox, malformed Priority independent-action behavior, minimum-data outcome, and zero forbidden shadow effects.
