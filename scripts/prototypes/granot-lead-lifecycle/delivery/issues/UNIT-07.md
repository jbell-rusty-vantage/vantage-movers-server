...
- **Original slice:** S05.
- **Specification and AC references:** Sections 11, 13, 27.1, 28.2 read skeleton, 33; AC-02 decision evidence, AC-31, Record Link portions of AC-32/35.
...
persistence models/indexes for Synchronization Decision, Lifecycle Activation, and Granot Record Link; historical/live-shadow/live classification; safe link-only evidence; activation command; initial health/Job projections without raw payloads.
...
- shadow on; all mutation/case flags off.
...
- **Approved unit-specific proof:** model/module tests for unique attempts, active Job link uniqueness, disputed-link lookup, write-once activation, historical cutoff permanence, safe projections, and historical processing producing no forbidden effects.
