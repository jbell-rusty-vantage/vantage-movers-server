...
- **Original slice:** S20.
- **Specification and AC references:** Sections 13 correction, 22, 24.5, 28–29; AC-23/26/27/35/36.
...
separate discrepancy models, stable non-PII fingerprints, open/refresh uniqueness, read projections, re-evaluate, no-action, Owner correction with expected link revision, old-link supersession/history, and discrepancy UI/timeline.
...
- **Approved unit-specific proof:** transaction/module tests for exact reason routing, concurrent refresh, correction race, selected eligible Lead, unchanged Lead Source Scope, re-evaluation opening normal reconciliation where appropriate, and no direct Booking/Cancellation mutation.
