...
- **Specification and AC references:** Section 17 and RingCentral guidance; AC-14–16.
...
shared convergence service, adoption-before-duplicate ordering, exact adoption criteria, atomic verified metadata + processed ledger, preserved Granot origin, durable pending/adopted/conflict states, and no false duplicate from the adopted physical call.
...
- do not change cron cadence in this unit.
...
- **Approved unit-specific proof:** RingCentral integration tests for one/zero/multiple candidates, ±12-hour boundary, Job-only exclusion, prior distinct qualifying Lead duplicate, complete ledger atomicity, and continued normal ingest on conflict.
