...
- **Specification and AC references:** Sections 24.2 and 24.5, Sections 28.3/29; AC-20/21/24/32.
...
full official replacement update on deterministic Booking, expected Booking/case revisions, No Action Domain Command without Entity Change/outbox, current-state revalidation, case resolution, admin update/no-action forms, and correct query invalidation.
...
- **Approved unit-specific proof:** concurrency/replay/already-satisfied tests; cannot change Job/Lead/source identity; cannot create second Booking; no-action leaves aggregates/outbox untouched; 409 refresh preserves unsent input.
