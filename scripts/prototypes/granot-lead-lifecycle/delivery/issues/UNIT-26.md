...
- **Original slice:** S17.
- **Specification and AC references:** Sections 18, 20–21, 28.2, 29; read portions AC-25–27/35/36/40.
...
Release case model/open-refresh/sequence, deterministic active Booking projection, already-cancelled behavior, no-Booking/conflict discrepancy routing seam, list/detail/timeline, current Booking display, and zero mutation commands.
...
Units 22–23 and stable Booking reads/identity.
...
- **Approved unit-specific proof:** concurrent uniqueness/sequence tests; active/already-cancelled/no-Booking distributions; Booked and Release cases coexist; masked APIs; admin detail with no automatic cancellation/update.
