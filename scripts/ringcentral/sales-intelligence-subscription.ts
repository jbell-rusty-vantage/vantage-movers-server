 ...
 *
 *   node --env-file=.env --import tsx scripts/ringcentral/sales-intelligence-subscription.ts [--action plan|list|ensure|renew|repair] [--id <subscriptionId>] [--confirm-production-subscription]
 *
