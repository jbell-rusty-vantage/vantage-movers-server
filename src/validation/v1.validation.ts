...
export {
  ...
  type ResolveGranotFormLeadInput,
  type GranotFormLeadSyncInput,
...
export {
  ...
  type SimpleCplScheduleInput,
  type AdvancedCplScheduleCommandInput,
  type CplCorrectionPreviewInput,
  type CreateCplCorrectionInput,
  type CancelCplCorrectionInput,
  type RingCentralRouteListQuery,
  type RingCentralRouteCreateInput,
