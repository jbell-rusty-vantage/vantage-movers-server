...
const SNAPSHOT_FIXTURE = {
  ...
  metrics: {
    ...
    bookings: { today: 6, yesterday: 5, yesterday_by_now: 4, day_before: 4, day_before_by_now: 3 },
    cancellations: { today: 1, yesterday: 0, yesterday_by_now: 0, day_before: 1, day_before_by_now: 0 },
    texts: {
      today: 19,
      yesterday: 22,
      yesterday_by_now: 18,
      day_before: 20,
      day_before_by_now: 15,
      deferred: 4,
      held_now: 3,
      skipped: 4,
      failed: 1,
    ...
    webhooks: {
      ...
      priority_updated: { today: 120, yesterday: 101, day_before: 101 },
      booking_status_changed: { today: 8, yesterday: 7, day_before: 7 },
      booked: { today: 5, yesterday: 4, day_before: 4 },
      release: { today: 3, yesterday: 3, day_before: 3 },
    },
  ...
  companies: SOURCE_COMPANIES.map((source_company) => ({
    ...
    day_before_total: source_company === "top10_leads" ? 14 : 0,
  })),
  hourly: { today: [], yesterday: [], day_before: [] },
};
