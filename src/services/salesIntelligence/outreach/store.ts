...
export async function closeRecord(record: Awaited<ReturnType<typeof recordForUpdate>>, reason: string, origin: "official" | "owner", context: CsiTransactionContext) {
  ...
  await refreshRecord(record, context, "outreach_closed", prior);
